...
vi.mock('@/services/posterApi', () => ({
  ...
  persistAsset: vi.fn().mockResolvedValue({
    id: 'gen', url: 'https://pub/gen.webp', contentType: 'image/webp',
...
const processed: ProcessedImage = {
  ...
  width: 10, height: 20, compressedBytes: 3, originalBytes: 9, ratio: 3,
  quality: 0.9, mimeType: 'image/webp', originalName: 'a.webp',
}
