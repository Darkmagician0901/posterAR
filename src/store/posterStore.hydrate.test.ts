...
const remote = (id: string): RemoteAsset => ({
  id, url: `https://pub/${id}.webp`, contentType: 'image/webp',
  isAnimated: false, width: 100, height: 100, originalName: `${id}.webp`,
})

describe('hydrateUploads', () => {
  beforeEach(() => {
    usePosterStore.setState({ uploadedPosters: [], currentPosterImage: '/posters/default-poster.png' })
  })
